    ...
    render(){
        ...
        return(
            <Animated.View style={styles.area}>
               <Animated.View style={[styles.seta,{transform:[{perspective:1000},{rotate:r1} ] } ]}></Animated.View>
               <Animated.View style={[styles.seta,{transform:[{perspective:1000},{rotate:r2}]}]}></Animated.View> 
            </Animated.View>
        );
    }
}
